    ...
    <head>
        ...
        <style>
            ...
            .form-control:focus,.form-select:focus{
                ...
                box-shadow:0 0 0 .25rem rgba(224,184,65,.25)
            }
            .btn-gold{
                background:var(--gold);
                color:var(--black);
            ...
            (function () {
                ...
                const todayStr = `${yyyy}-${mm}-${dd}`;
                        ...
                        note.addEventListener('input', () => {
                            updateNoteCount();
                            noteErr.style.display = (note.value.length > 200) ? 'block' : 'none';
                        });
                        ...
                        form.addEventListener('submit', (e) => {
                            ...
                            // chọn ca
                            if (!slot.value || !timeHidden.value) {
                                ok = false;
                                slotHint.textContent = '⚠️ Vui lòng chọn ca đặt bàn.';
                                slotHint.style.color = '#FF6B6B';
                            } else {
                                slotHint.style.color = '#E0B841';
                            }
