...
<html lang="vi">
    <head>
        ...
        <style>
            :root {
                ...
                --primary-gradient: linear-gradient(135deg, #5e3bb7 0%, #7c5cd6 100%);
                --bg: #f8f9ff;
                --card-bg: #ffffff;
                --text: #2d3436;
                --text-light: #636e72;
                --border: #e2e8f0;
                --shadow-sm: 0 4px 15px rgba(94, 59, 183, 0.08);
                --shadow-md: 0 10px 30px rgba(94, 59, 183, 0.12);
                --radius: 18px;
    ...
    const colors = ['#5e3bb7', '#7c5cd6', '#a78bff', '#d9c8ff', '#00d2d3', '#f39c12'];
    ...
    new Chart(document.getElementById('paymentChart'), {
        type: 'bar',
        data: {labels: paymentLabels, datasets: [{label: 'Số lượng', data: paymentData, backgroundColor: '#5e3bb7', borderRadius: 8}]},
        options: {...chartConfig, scales: {y: {beginAtZero: true, grid: {display: false}}}}
    });

    new Chart(document.getElementById('tableAreaChart'), {
        type: 'bar',
        data: {labels: areaLabels, datasets: [{label: 'Số bàn', data: areaData, backgroundColor: '#7c5cd6', borderRadius: 8}]},
        options: {...chartConfig, scales: {y: {beginAtZero: true, grid: {display: false}}}}
    });
        </script>
