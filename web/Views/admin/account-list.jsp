...
<head>
    ...
    <style>
        ...
        .status-active { color: green; font-weight: 500; }
        .status-inactive { color: red; font-weight: 500; }
        .role-admin { color: #e67e22; font-weight: bold; }
        .role-staff { color: #2980b9; font-weight: bold; }
        .role-customer { color: #27ae60; font-weight: bold; }
        .actions a {
            margin: 0 6px;
        ...
        .btn-add:hover { background-color: #5012a0; }
    </style>
</head>
